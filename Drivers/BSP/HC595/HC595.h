...
#define HC595_SDI_GPIO_CLK_ENABLE()           do{ RCC->APB2ENR |= 1 << 3; }while(0)   /* PC口时钟使能 */

/*HC595 CLK */
#define HC595_CLK_GPIO_PORT                  GPIOB
#define HC595_CLK_GPIO_PIN                   SYS_GPIO_PIN1
#define HC595_CLK_GPIO_CLK_ENABLE()           do{ RCC->APB2ENR |= 1 << 3; }while(0)   /* PC口时钟使能 */

/*HC595 LE */
#define HC595_LE_GPIO_PORT                  GPIOB
#define HC595_LE_GPIO_PIN                   SYS_GPIO_PIN5
#define HC595_LE_GPIO_CLK_ENABLE()           do{ RCC->APB2ENR |= 1 << 3; }while(0)   /* PC口时钟使能 */

/*HC595 OE */
#define HC595_OE_GPIO_PORT                  GPIOB
#define HC595_OE_GPIO_PIN                   SYS_GPIO_PIN6
#define HC595_OE_GPIO_CLK_ENABLE()           do{ RCC->APB2ENR |= 1 << 3; }while(0)   /* PC口时钟使能 */
...
#define HC595_OE(x)             sys_gpio_pin_set(HC595_OE_GPIO_PORT, HC595_OE_GPIO_PIN, x)      /* OE */
